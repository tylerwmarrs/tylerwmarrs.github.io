...
BLOG_AUTHOR = "Tyler Marrs"  # (translatable)
BLOG_TITLE = "Tyler Marrs"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://tylermarrs.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://tylermarrs.com/"
BLOG_EMAIL = "tylerwmarrs@gmail.com"
BLOG_DESCRIPTION = "Yet another data scientist's blog."  # (translatable)
...
DEPLOY_COMMANDS = {
    'default': [
        "rsync -rav -e ssh --delete output/ tyler@tylermarrs.com:/home/tyler/www/tylermarrs.com/www",
    ]
}
